...
public class FunGame2020 extends MultiPageScoutingActivity {
...
//            parent.setContentView(R.layout.fungame2020);
//        }
//
//        @Override
...
//
//            m.put("Comments", parent.getTypedView(R.id.comments, EditText.class).getText().toString());
//            m.put("Rating", (int) parent.getTypedView(R.id.rating, RatingBar.class).getRating());//The rating is only ever going to be an int anyways...
//        }
//    }


    public FunGame2020() {
        super(new FunGame2020.SecondPage());
    }
